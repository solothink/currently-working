...
const DEMO_DATA = [
  {
    id: 1,
    clientName: "Gauahar Khan",
    clientAddress: "Malaysia",
    content:
      "Thanks to Idbook hotels for a hassle free vacation. Anyone out there who is planning for a vacation, Idbook hotels is your man!",
  },
  {
    id: 2,
    clientName: "Anonymous",
    clientAddress: "Punjab",
    content: "Visited Kashmir through Idbook hotels, Perfect trip",
  },
  {
    id: 3,
    clientName: "Mayank & Chanchal",
    clientAddress: "Tokyo",
    content: "Hassle free vacation to Kashmir, all thanks to Idbook hotels",
  },
];
...
const SectionClientSay: FC<SectionClientSayProps> = ({
  ...
  return (
    <div className={`nc-SectionClientSay relative ${className} `}>
      <Heading desc="Let's see what people think of Idbook" isCenter>
