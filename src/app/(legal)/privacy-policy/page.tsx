...
export const metadata: Metadata = {
  title: "Privacy Policy | Idbook Hospitality™",
  description:
    "Read Idbook Hospitality's Privacy Policy to understand how we collect, use, and protect your personal information. We are committed to safeguarding your privacy while providing top-notch hospitality services. Learn about your rights and our practices in data management.",
};
  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <p className="text-gray-600 mb-2">
        Idbook is dedicated to safeguarding the privacy of its users, and this
        privacy policy outlines the information we collect, how we utilize it,
        and the measures we take to ensure its protection. The policy also
        elucidates user rights and provides contact information for any
        inquiries.
      </p>
      ...
      <h3 className="text-lg font-medium mt-6">Definitions</h3>
      ...
      <ul className="list-disc list-inside ml-4 text-gray-600">
        ...
        <li>
          <strong>Application</strong> refers to IdbookHotels, the software
          program provided by the Company.
        </li>
        <li>
          <strong>Company</strong> (referred to as either "the Company", "We",
          "Us" or "Our" in this Agreement) refers to Idbook Hospitality Private
          Limited.
        </li>
        <li>
        ...
        <li>
          <strong>Website</strong> refers to Idbook hotels, accessible from
          https://www.idbookhotels.com/
        </li>
        <li>
      ...
      <h5 className="text-lg font-semibold mb-2">Usage Data</h5>
      <p className="mb-6">
      ...
      <p className="mb-4">The technologies We use may include:</p>
      <ul className="list-disc ml-8 mb-4">
        <li className="mb-2">
      ...
      <h3 className="text-2xl font-semibold mb-4">Use of Your Personal Data</h3>
      <p className="mb-4">
      ...
      <h3 className="text-2xl font-semibold mb-4">Delete Your Personal Data</h3>
      <p className="mb-4">
      ...
      <p className="mb-4">
        ...
        so by law or in response to valid requests by public authorities (e.g.,
      ...
      <h3 className="text-2xl font-semibold mb-4">Links to Other Websites</h3>
      <p className="mb-4">
      ...
      <ul className="list-disc ml-8 mb-4">
        <li>
          By email:{" "}
          <a href="mailto:accounts@idbookhotels.com" className="text-blue-500">
            accounts@idbookhotels.com
          </a>
        </li>
        <li>
          By visiting this page on our website:{" "}
          <a href="https://www.idbookhotels.com" className="text-blue-500">
            https://www.idbookhotels.com
          </a>
        </li>
        <li>By phone number: +91 81001 50924</li>
        <li>
          By mail: PLOT NO 234, GROUND FLOOR, OPPOSITE ICICI BANK ATM, NEAR
          POLICE STATION, SECTOR 18, SARHAUL, GURUGRAM, HARYANA, 122015
        </li>
      </ul>
    </div>
  );
