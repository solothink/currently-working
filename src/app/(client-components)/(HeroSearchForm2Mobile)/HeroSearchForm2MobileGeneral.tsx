...
import StaySearchFormGeneral from "./(stay-search-form)/StaySearchFormGeneral";

const HeroSearchForm2MobileGeneral = () => {
                  ...
                  {showDialog && (
                    <Tab.Group manual>
                      ...
                      <Tab.List className="pt-12 flex w-full justify-center font-semibold text-sm sm:text-base text-neutral-500 dark:text-neutral-400 space-x-6 sm:space-x-8">
                        {["Stay", "Holiday Package", "Cars", "Flights"].map(
                          (item, index) => (
...
export default HeroSearchForm2MobileGeneral;
