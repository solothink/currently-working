...
export default function AvatarDropdown({ className = "" }: Props) {
  ...
  const { activeGroup, hasUserRole } = useAccountStore();
                  ...
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    ...
                    >
                      <div className="flex items-center justify-center flex-shrink-0 text-neutral-500 dark:text-neutral-300">
                        ...
                        >
                          <path
                            d="M20 4H4C2.89 4 2 4.89 2 6V18C2 19.11 2.89 20 4 20H20C21.11 20 22 19.11 22 18V6C22 4.89 21.11 4 20 4ZM20 18H4V8H20V18ZM4 6H20V7H4V6Z"
                            stroke="currentColor"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                      ...
                      <>
                        ...
                        {hasUserRole("CORP-ADMIN") && (
                          ...
                          >
                            <div className="flex items-center justify-center flex-shrink-0 text-neutral-500 dark:text-neutral-300">
                              ...
                              >
                                <path
                                  d="M3 3V21H21V3H3ZM12 17H8V13H12V17ZM16 17H14V10H16V17ZM20 17H18V7H20V17Z"
                                  stroke="currentColor"
                                  stroke-width="1.5"
                        ...
                        >
                          <div className="flex items-center justify-center flex-shrink-0 text-neutral-500 dark:text-neutral-300">
                            ...
                            >
                              <path
                                d="M8 2V4M16 2V4M4 7H20M4 7V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V7M4 7H20M12 12H8V16H12V12Z"
                                stroke="currentColor"
                                stroke-width="1.5"
                                stroke-linecap="round"
                                stroke-linejoin="round"
